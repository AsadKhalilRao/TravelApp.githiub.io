...
import {ReusableText,ReusableBtn,Recommendations,HeighSpacer,PlacesForHome,BestHostelComponent} from "../../components/index"
...
const Home=({navigation})=> {
    ...
    return (
        <SafeAreaView style={ReusableStyles.container}>
          ...
          size={SIZES.large}
          color={COLORS.black}/>
          <TouchableOpacity style={HomeStyles.box} onPress={()=>{navigation.navigate("Search")}}>
